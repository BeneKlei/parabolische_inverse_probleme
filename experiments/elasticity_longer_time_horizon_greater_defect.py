...
TR_optimizer_parameter__['enrichment']['state_basis']['compression']['HaPOD'] = {'HaPOD_tol': 1e-12}
...
EXPERIMENTS['TR_sensors_time_step_HaPOD_1e-12'] = (setup_sensors, TR_optimizer_parameter_sensors)
#EXPERIMENTS['TR_identity_time_step'] = (setup_identity, TR_optimizer_parameter_identity)
