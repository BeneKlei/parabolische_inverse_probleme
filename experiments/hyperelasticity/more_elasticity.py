...
FOM_optimizer_parameter_identity['tau'] = identity_tau
FOM_optimizer_parameter_grid['tau'] = gird_tau
...
TR_optimizer_parameter_identity['tau'] = identity_tau
TR_optimizer_parameter_grid['tau'] = gird_tau
...
prefix = 'elasticity_high_res_radius_TR'
