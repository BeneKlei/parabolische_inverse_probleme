...
for noise_level in noise_levels:
    ...
    TR_optimizer_parameter__['enrichment']['parameter_basis'] = None
    ...
    EXPERIMENTS[f'TR_sensors_noise_level_{noise_level}_state_red'] = (setup_sensors, TR_optimizer_parameter_sensors)

    #----------------------------------------------------------------------------------------

    TR_optimizer_parameter__ = copy.deepcopy(TR_optimizer_parameter_)

    TR_optimizer_parameter__['enrichment']['state_basis']['additional_snapshots']['include_lin_states'] = True
