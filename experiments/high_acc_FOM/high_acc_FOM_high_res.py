...
reaction_500_setup = set_dims(reaction_500_setup, N = 500, q_time_dep=True, nt=nt)

reaction_500_setup_non_time_dep = copy.deepcopy(reaction_setup)
reaction_500_setup_non_time_dep = set_dims(reaction_500_setup_non_time_dep, N = 500, q_time_dep=False, nt=nt)

diffusion_500_setup = copy.deepcopy(diffusion_setup)
diffusion_500_setup = set_dims(diffusion_500_setup, N = 500, q_time_dep=True, nt=nt)

diffusion_500_setup_non_time_dep = copy.deepcopy(diffusion_setup)
diffusion_500_setup_non_time_dep = set_dims(diffusion_500_setup_non_time_dep, N = 500, q_time_dep=False, nt=nt)
...
EXPERIMENTS['reaction_FOM_500_time_dep_1e-9'] = (setup, optimizer_parameter)
...
optimizer_parameter['q_0'] = setup['model_parameter']['q_circ']
optimizer_parameter['noise_level'] = setup['model_parameter']['noise_level']
EXPERIMENTS['reaction_FOM_500_non_time_dep_1e-9'] = (setup, optimizer_parameter)
