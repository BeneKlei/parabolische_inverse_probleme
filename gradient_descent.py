...
def gradient_descent(
    ...
    print(f"Initial objective = {current_J}.")
    ...
    for i in range(max_iter):
        ...
        print(f"Iteration {i+1}: objective = {current_J}, norm gradient = {np.linalg.norm(model.compute_linearized_gradient(q, current_d, alpha).to_numpy())}.")
