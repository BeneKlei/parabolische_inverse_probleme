...
def discretize_instationary_IP(analytical_problem, diameter, opt_data,
    ...
    if not opt_data['B_assemble']:                                               # no preassembly
        ...
        assembled_model, primal_fom_data = discretize_instationary_cg(analytical_problem,
                                                               diameter=diameter,
                                                               grid_type=grid_type,
                                                               preassemble= True,
                                                               nt = nt)
    ...
    # energy_product_fom, _ = discretize_instationary_cg(energy_product_problem,
    #                                                    diameter=diameter,
    #                                                    grid_type=grid_type,
    #                                                    preassemble= True,
    ...
    products = primal_fom.products.copy()
    ...
    fom_IP = InstationaryModelIP(assembled_model, primal_fom_data, opt_data,
                                 products = products,
                                 estimators = None,
                                 name = 'fom_IP',
